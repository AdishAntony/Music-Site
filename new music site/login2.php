...
<center><h3>Login With Your Username and Password</h3>
<form  id="form1" name="form1" method="post" action="actionlogin.php"  enctype="multipart/form-data">
...
<font color="#CC0000"><table align="center">
 ...
 <tr>
  ...
  <tr>
   <td><input name="b1" type="submit" value="Login" style="background-color:#66CCFF; color:#6000fff"/></td>
 ...
 Sorry Wrong Username or Password<br>
   Try again using proper username and password
</form>
   	<br>
<br>
<br>
